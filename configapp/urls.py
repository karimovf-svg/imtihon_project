...
urlpatterns = [
    ...
    path('course/teacher_get_group/', TeacherGetGroup.as_view(), name='teacher_get_group'),
    path('course/teacher_get_student/<int:pk>/', TeacherGetStudent.as_view(), name='teacher_get_student'),
